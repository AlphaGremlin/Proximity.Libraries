...
namespace Proximity.Utility.Collections
{
	...
	public static class ImmutableCountedStack
	{
		...
		{	//****************************************
			...
			do
			{
				OldStack = Volatile.Read(ref stack);
	...
	/// </summary>
	public sealed class ImmutableCountedStack<TItem> : IImmutableStack<TItem>, IEnumerable<TItem>
	{
		/// <summary>
		...
		IImmutableStack<TItem> IImmutableStack<TItem>.Clear()
		{
			return Empty;
		}
		...
		IImmutableStack<TItem> IImmutableStack<TItem>.Push(TItem item)
		{
			return new ImmutableCountedStack<TItem>(item, this, _Count + 1);
		}
