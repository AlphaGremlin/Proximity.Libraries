...
namespace Proximity.Buffers.Collections
{
	...
	internal static class HashUtil
	{
		...
		internal static int GetPrime(int minimum)
		{
			...
			var Index = NearestAboveAscending(Primes, minimum);
		...
		private static int NearestAboveAscending<T>(IList<T> list, T targetValue) where T : IComparable<T>
		{ //****************************************
