...
namespace System.Threading.Tasks.Sources
{
	...
	internal sealed class ManualResetValueTaskSourceCore<TResult>
	{
		/// <summary>
		...
		private void InvokeContinuation()
		{
			...
			case null:
				if (RunContinuationsAsynchronously)
				{
					if (_executionContext != null)
					{
						ThreadPool.QueueUserWorkItem(InnerInvokeContinuation, this);
					}
					else
					{
						ThreadPool.UnsafeQueueUserWorkItem(InnerInvokeContinuation, this);
					}
				}
				else
				{
			...
			case SynchronizationContext sc:
				sc.Post(InnerInvokeContinuation, this);
				break;
