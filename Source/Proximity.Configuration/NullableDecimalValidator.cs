...
namespace Proximity.Configuration
{
	...
	{	//****************************************
		private readonly decimal _MinValue = decimal.MinValue, _MaxValue = decimal.MaxValue;
		...
		public override bool CanValidate(Type type) => type == typeof(decimal?) || type == typeof(decimal);
