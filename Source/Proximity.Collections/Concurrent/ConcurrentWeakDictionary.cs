...
namespace System.Collections.Concurrent
{
	...
	public class ConcurrentWeakDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>> where TValue : class where TKey : notnull
	{	//****************************************
		...
		public TValue GetOrAdd(TKey key, Func<TKey, TValue> valueCallback) => GetOrAdd(key, valueCallback, out _);
		...
		/// <returns>The new or existing value</returns>
		public TValue GetOrAdd(TKey key, TValue value) => GetOrAdd(key, value, out _);
		...
		{	//****************************************
			var MyDictionary = new Dictionary<TKey, TValue>(_Dictionary.Count, Comparer);
			//****************************************
