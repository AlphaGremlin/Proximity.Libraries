...
namespace System.Collections.Generic
{
	...
	{ //****************************************
		...
		public IndexedDictionary(int capacity, IEqualityComparer<TKey>? comparer)
		{
			...
			Keys = new IndexedDictionaryKeys(this);
			Values = new IndexedDictionaryValues(this);
		}
		...
		/// </summary>
		public IndexedDictionaryCollection<TKey> Keys { get; }

		/// <summary>
		/// Gets a collection of values
		/// </summary>
		public IndexedDictionaryCollection<TValue> Values { get; }
		...
		public abstract class IndexedDictionaryCollection<T> : IList<T>, IReadOnlyList<T>, IList
		{
			internal IndexedDictionaryCollection(IndexedDictionary<TKey, TValue> parent)
			{
				Parent = parent;
			}
		...
		private sealed class IndexedDictionaryKeys : IndexedDictionaryCollection<TKey>
		{
			internal IndexedDictionaryKeys(IndexedDictionary<TKey, TValue> parent) : base(parent)
			{
			}
			...
			public override IEnumerator<TKey> GetEnumerator() => new KeyEnumerator(Parent);
		...
		private sealed class IndexedDictionaryValues: IndexedDictionaryCollection<TValue>
		{
			internal IndexedDictionaryValues(IndexedDictionary<TKey, TValue> parent) : base(parent)
			{
			}
			...
			public override IEnumerator<TValue> GetEnumerator() => new ValueEnumerator(Parent);
