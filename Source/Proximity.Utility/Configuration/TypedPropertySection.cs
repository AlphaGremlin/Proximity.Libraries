...
{
	/// <summary>
	/// Represents a Configuration Section that can have properties with Typed Elements
	/// </summary>
	public abstract class TypedPropertySection : ConfigurationSection
	{
		/// <summary>
		/// Creates a new Configuration Section that can have properties with Typed Elements
		/// </summary>
		public TypedPropertySection() : base()
		{
		}
