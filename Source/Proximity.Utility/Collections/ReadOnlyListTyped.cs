...
namespace Proximity.Utility.Collections
{
	...
	{	//****************************************
		...
		public IEnumerator<TTarget> GetEnumerator() => new TypedEnumerator<TSource, TTarget>(_Source.GetEnumerator());

		//****************************************

		void IList<TTarget>.Insert(int index, TTarget item) => throw new NotSupportedException("List is read-only");

		void IList<TTarget>.RemoveAt(int index) => throw new NotSupportedException("List is read-only");

		void ICollection<TTarget>.Add(TTarget item) => throw new NotSupportedException("List is read-only");

		void ICollection<TTarget>.Clear() => throw new NotSupportedException("List is read-only");

		IEnumerator IEnumerable.GetEnumerator() => _Source.GetEnumerator();

		bool ICollection<TTarget>.Remove(TTarget item) => throw new NotSupportedException("List is read-only");
		...
		/// </summary>
		public TTarget this[int index] => _Source[index];
