...
namespace Proximity.Utility.Collections
{
	...
	/// </summary>
	public abstract class ReadOnlyDictionaryChild<TKey, TValue, TChild> : IDictionary<TKey, TChild>, ICollection<TChild>
#if !NET40
		, IReadOnlyCollection<TChild>, IReadOnlyDictionary<TKey, TChild>
#endif
	{	//****************************************
