...
namespace Proximity.Utility
{
	...
	public static class WeakDelegateSlim
	{
		...
		public static TDelegate CreateDynamic<TDelegate>(TDelegate callback) where TDelegate : class
		{		//****************************************
...
#if IOS
			var MyHandler = new DelegateHandler<Action>(callback.Target, callback.Method);
#else
...
#if IOS
			var MyHandler = new DelegateHandler<Action<T0>, T0>(callback.Target, callback.Method);
#else
...
#if IOS
			var MyHandler = new DelegateHandler<Action<T0, T1>, T0, T1>(callback.Target, callback.Method);
#else
...
#if IOS
			var MyHandler = new DelegateHandler<Action<T0, T1, T2>, T0, T1, T2>(callback.Target, callback.Method);
#else
...
#if IOS
			var MyHandler = new DelegateHandler<Action<T0, T1, T2, T3>, T0, T1, T2, T3>(callback.Target, callback.Method);
#else
...
#if IOS
			var MyHandler = new DelegateHandler<Action<T0, T1, T2, T3, T4>, T0, T1, T2, T3, T4>(callback.Target, callback.Method);
#else
...
#if IOS
			protected void OpenDelegate(object target, params object[] args)
			{
		...
		{	//****************************************
			private readonly TOpenDelegate _OpenDelegate;
			//****************************************
			
			protected DelegateBase(object target, MethodInfo method) : base(target, method)
			{
				_OpenDelegate = Delegate.CreateDelegate(typeof(TOpenDelegate), method) as TOpenDelegate;
			}
			
			//****************************************
			
			public TOpenDelegate OpenDelegate
			{
		...
		{
			public DelegateHandler(TTarget target, MethodInfo method) : base(target, method)
			{
			}
...
#else
		private sealed class DelegateHandler<TDelegate> : DelegateBase<TDelegate> where TDelegate : class
		{
			public DelegateHandler(object target, MethodInfo method) : base(target, method)
			{
			}
		...
		private sealed class DelegateHandler<TDelegate, T1> : DelegateBase<TDelegate> where TDelegate : class
		{
			public DelegateHandler(object target, MethodInfo method) : base(target, method)
			{
			}
		...
		private sealed class DelegateHandler<TDelegate, T1, T2> : DelegateBase<TDelegate> where TDelegate : class
		{
			public DelegateHandler(object target, MethodInfo method) : base(target, method)
			{
			}
		...
		private sealed class DelegateHandler<TDelegate, T1, T2, T3> : DelegateBase<TDelegate> where TDelegate : class
		{
			public DelegateHandler(object target, MethodInfo method) : base(target, method)
			{
			}
		...
		private sealed class DelegateHandler<TDelegate, T1, T2, T3, T4> : DelegateBase<TDelegate> where TDelegate : class
		{
			public DelegateHandler(object target, MethodInfo method) : base(target, method)
			{
			}
		...
		private sealed class DelegateHandler<TDelegate, T1, T2, T3, T4, T5> : DelegateBase<TDelegate> where TDelegate : class
		{
			public DelegateHandler(object target, MethodInfo method) : base(target, method)
			{
			}
